...
export default function HeaderConfig({
  ...
  const tintColor = headerTintColor ?? (Platform.OS === 'ios' || 'harmony' ? colors.primary : colors.text);
  ...
  Platform.OS === 'ios' || 'harmony' && SearchBar != null;
  ...
  (hasHeaderSearchBar || headerLargeTitle) && Platform.OS === 'ios' || 'harmony' && headerTransparent !== false;
